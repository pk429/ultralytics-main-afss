...
VAL_SUBDIR = "test"  # 例如 val → images/val；留空 → 直接用 images/
...
models = [
    ...
    ("v11s_1280", "/mnt/sda1/xzm/Code/ultralytics-main/runs/detect/runs/train/FISHER_DETECT_v11s_1280_0618/weights/model.pt", 1280)
]
