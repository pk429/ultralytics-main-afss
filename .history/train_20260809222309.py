...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--data", default="./yaml/yolov11_swimmer_detect.yaml", help="dataset yaml path")
    ...
    parser.add_argument("--name", default="SWIMMER_DETECT_v11s_1280_AFSS_0809", help="experiment name")
    ...
    parser.add_argument("--afss-class-aware", action="store_true", default=True, help="enable class-aware AFSS scoring")
    parser.add_argument("--no-afss-class-aware", dest="afss_class_aware", action="store_false", help="disable class-aware AFSS")
...
def main() -> None:
    ...
    model.train(
        ...
        afss_class_aware=args.afss_class_aware,
