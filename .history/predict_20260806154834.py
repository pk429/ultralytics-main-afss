...
if __name__ == '__main__':
    ...
    # 钓鱼识别
    model = YOLO(model='/mnt/sda1/xzm/Code/ultralytics-main/runs/detect/runs/train/FLOODGATE_DETECT_v11s_1280_0806/weights/best.pt')
    results = model.predict(
        source=r'/mnt/sda1/xzm/datasets/floodgate_dataset/split/images/test/',  # 视频路径
