...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--data", default="./yaml/yolov11_flooddgate_detect.yaml", help="dataset yaml path")
    ...
    parser.add_argument("--name", default="FLOODGATE_DETECT_v11s_1280_AFSS", help="experiment name")
