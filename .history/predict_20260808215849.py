...
if __name__ == '__main__':
    ...
    # 钓鱼识别
    model = YOLO(model=' /mnt/sda1/xzm/Code/ultralytics-main-afss/runs/detect/runs/train/SWIMMER_DETECT_v11s_1280_AFSS_0807/weights/best.pt')
    results = model.predict(
        source=r'/mnt/sda1/xzm/datasets/swimmer/data/20260807/images/',  # 视频路径
